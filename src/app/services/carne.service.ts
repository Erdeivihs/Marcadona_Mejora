...
export class CarneService {
    url = "https://daw2021-2022-default-rtdb.firebaseio.com/Marcadona/Carne.json";
    
    frutaSubject = new Subject<Carne[]>();
    ...
    public getCarnes(): Observable<Carne[]> {
    
          return this.http.get<{ [key: string]: Carne }>(this.url, this.httpOptions)
            .pipe(
